...
CREATE TABLE comp_prblm(
    prblm_id int,
    comp_id  int,
    FOREIGN KEY (prblm_id) REFERENCES problem_set(prblm_id),
    FOREIGN KEY (comp_id) REFERENCES competition(comp_id)
);
...
/*SuperUser0@*/
INSERT INTO `users` (`st_id`, `name`, `position`, `dept`, `password`, `email`, `phone`, `image_path`, `address`, `github`, `facebook`, `linkedin`, `admin_level`) VALUES ('011202037', 'Delwar Shahadat Deepu', 'general', 'cse', '859c5edcb694e2c092e31c0577a02f47', 'deepu2@gmail.com', '01945673876', 'assets/uploads/deepu2@gmail.com.jpg', 'Gazipur', 'https://github.com/deepu107', 'https://www.facebook.com/MDS.Deepu.1067', 'https://www.linkedin.com/in/delwar-shahadat-578090', '0');
/*GenUser33@*/


/*Problem table insertions by shovon*/
